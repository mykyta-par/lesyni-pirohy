...
<div class="oco-wrap">
    ...
    <form id="oco-wc-form" name="checkout" style="display:none;">
        ...
        <input type="hidden" name="shipping_method[0]" id="oco-shipping-method-val" value="lesyni_zone_rate">
    ...
    <div class="oco-grid">
        ...
        <div class="oco-left">
            ...
            <div class="oco-card">
                ...
                $np_rate_key = $np_enabled ? lesyni_get_np_rate_key()    : '';
                $np_cost     = $np_enabled ? lesyni_get_np_display_cost() : 0;
                ?>
            ...
            <div class="oco-card" id="oco-when-section">
                ...
                <p class="oco-time-notice">Зверніть увагу: обрані вами дата та час доставки є попередніми. Фактичні терміни виконання замовлення можуть відрізнятися. Точний час буде підтверджено нашим оператором під час телефонного дзвінка.</p>
            </div>
    ...
    <?php
    // Suggestions section — show up to 4 featured/recent products
